...
function settingsSetup() {
  ...
  // by making your label variable equal createElement('label').parent('ballSettings');
  heightLabel = createElement('label').parent('ballSettings');
  
  // The slider variable is not as straightforward; it needs to equal: 
  ...
  //                          ↓    ↓    ↓   ↓         ↓
  heightSlider = createSlider(1, 5000, 12, .5).id('heightSlider').parent('ballSettings');
...
function settingsEdit() {
  ...
  // Make the value of the slider equal the ball's value here! ↓
